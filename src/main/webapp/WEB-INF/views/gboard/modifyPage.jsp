					...
					<div class="box-body">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">BNO</label> <input type="text"
								name='bno' class="form-control" value="${gboardVO.bno}"
								readonly="readonly">
						</div>
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="content" rows="3">${gboardVO.content}</textarea>
						</div>
									...
									function() {
										...
										$(".btn-warning")
												.on(
														"click",
														function() {
															self.location = "/gboard/list?page=${cri.page}&perPageNum=${cri.perPageNum}"
