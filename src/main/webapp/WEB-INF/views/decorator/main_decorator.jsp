			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					<li class="treeview"><a href="#"> <i
							class="fa fa-users"></i> <span>게임 리뷰 게시판</span> <i
							class="fa fa-angle-left pull-right"></i>
					</a>
						<ul class="treeview-menu">
							<li><a href="http://localhost:8080/gboard/list"><i
									class="fa fa-list"></i>메인 게시판</a></li>
							<li><a href="http://localhost:8080/user/login"><i
									class="fa fa-user"></i>로그인</a></li>
							<li><a href="http://localhost:8080/user/logout"><i
									class="fa fa-user-times"></i>로그아웃</a></li>
						</ul></li>
